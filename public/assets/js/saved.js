	...
	$.getJSON("/articles", function (data) {
		...
		for (var i = 0; i < data.length; i++) {
			...
			if (data[i].saved === true) {
				...
				$("#saved-results").append("<div class='saved-div'><p class='saved-text article-title'>" + data[i].title + "</p><p style='float: left;'>" + data[i].description +
					...
					"'><span class='icon'><i class='fa fa-comments'></i></span>Comments</a></div><br>");
			}
		}
	});
